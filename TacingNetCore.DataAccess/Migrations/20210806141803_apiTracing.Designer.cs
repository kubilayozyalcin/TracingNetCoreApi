...
namespace TacingNetCore.DataAccess.Migrations
{
    ...
    [Migration("20210806141803_apiTracing")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TracingNetCore.Entities.Concrete.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TracingNetCore.Entities.Concrete.Device", b =>
                {
                    b.HasOne("TracingNetCore.Entities.Concrete.DeviceType", "DeviceType")
                        .WithMany()
                        .HasForeignKey("DeviceTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TracingNetCore.Entities.Concrete.Region", "Region")
                        .WithMany()
            ...
            modelBuilder.Entity("TracingNetCore.Entities.Concrete.Employee", b =>
                {
                    b.HasOne("TracingNetCore.Entities.Concrete.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("TracingNetCore.Entities.Concrete.EmployeeDevice", b =>
                {
                    b.HasOne("TracingNetCore.Entities.Concrete.Device", "Device")
                        .WithMany()
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TracingNetCore.Entities.Concrete.Employee", "Employee")
                        .WithMany()
